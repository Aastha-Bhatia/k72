...
const Navbar=()=>{
  ...
  return(
    <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
        <div className='lg:w-34 w-31 p-3'>
        ...
        className="bg-black relative lg:h-13 h-11 lg:w-[17vw] w-46"> 
            <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
            <div className='relative h-full lg:px-12 lg:px-8 px-6 flex flex-col justify-center items-end lg:gap-1 lg:gap-1.5 gap-1'>
                    <div className="lg:w-13 w-10 h-[0.2vh] bg-white"></div>
                    <div className="lg:w-6 w-4 h-[0.2vh] bg-white"></div>
                </div>
        </div>
    </div>
